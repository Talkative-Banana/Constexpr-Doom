...
(module
  ...
  (func $A::A__ (type 0) (param i32) (result i32)
    ...
    local.get 4
    return)
  (func $A::hello__ (type 0) (param i32) (result i32)
    ...
    local.get 4
    return)
  (func $B::hello__ (type 0) (param i32) (result i32)
    (local i32 i32 i32 i32)
    global.get $__stack_pointer
    local.set 1
    i32.const 16
    ...
    local.get 4
    return)
  (func $C::hello__ (type 0) (param i32) (result i32)
    (local i32 i32 i32 i32)
    global.get $__stack_pointer
    local.set 1
    i32.const 16
  ...
  (export "memory" (memory 0))
  (export "main" (func $main))
  (elem (;0;) (i32.const 1) func $B::hello__ $A::hello__ $C::hello__)
